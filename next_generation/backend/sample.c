...
#define OPTSTRING "+2" OPTSTRING_CAPTURE_COMMON OPTSTRING_DISSECT_COMMON "M:C:e:E:F:gG:hH:j:J:lo:O:PqQr:R:S:T:U:vVw:W:xX:Y:z:"
  ...
  printf("SLANK init_process_policies()\n");
  relinquish_special_privs_perm();
  printf("SLANK relinquish_special_privs_perm()\n");
  print_current_user();
  ...
  printf("SLANK init_progfile_dir()\n");

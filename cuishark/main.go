...
func main() {
  ...
  set_keybind(g, "PacketList", 'G', gocui.ModNone, page_bottom)
  set_keybind(g, "PacketDetail", 'g', gocui.ModNone, page_top)
  set_keybind(g, "PacketDetail", 'G', gocui.ModNone, page_bottom)
  set_keybind(g, "PacketByte", 'g', gocui.ModNone, page_top)
  set_keybind(g, "PacketByte", 'G', gocui.ModNone, page_bottom)
